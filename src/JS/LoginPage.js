...
const LoginPage = () => {
  ...
  return (
    <div className="main">
      <div className={`container ${isSignUp ? "is-hidden" : ""} ${"is-txR"}`} id="a-container">
      ...
      <div className={`container ${isSignUp ? "is-txl" : "is-hidden"}  ${isSignUp ? "is-z200" : ""}`} id="b-container">
      ...
      <div className={`switch ${isGx ? "is-gx" : ""} ${isSignUp ? "is-txr" : ""}`} id="switch-cnt">
